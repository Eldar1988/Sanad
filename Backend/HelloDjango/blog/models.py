...
class Post(models.Model):
    ...
    images = models.ManyToManyField(Image, verbose_name='Изображения', related_name='images', blank=True)
    videos = models.ManyToManyField(Video, verbose_name='Видео', related_name='videos', blank=True)
